    ...
    <div className="bg-white selection:bg-green-100 selection:text-green-900 font-sans">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex h-20 items-center justify-between">
            ...
            <nav className="hidden md:flex md:space-x-8 font-medium text-sm tracking-wide">
              {['Beneficios', 'Planes', 'Portafolio', 'Nosotros'].map((item) => (
                <a 
                  key={item} 
      ...
      <main>
          ...
          <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 mt-10">
            <div className="max-w-4xl text-left">
              ...
              <p className="text-xl text-gray-300 mb-10 max-w-2xl leading-relaxed">
                Páginas web ultra-rápidas, modernas y optimizadas para vender en La Serena, Coquimbo y todo el país. Tu competencia ya está en línea, ¿y tú?
              </p>
        ...
        <section id="beneficios" className="py-24 bg-gray-50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl italic">Beneficios Inmediatos</h2>
              <div className="h-1.5 w-20 bg-green-600 mx-auto mt-4 rounded-full"></div>
            </div>
            <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
              {[
                { icon: <Clock />, title: "Ventas 24/7", desc: "Tu página web trabaja por ti sin descanso, captando clientes incluso mientras duermes." },
                { icon: <MapPin />, title: "Posicionamiento Local", desc: "Optimizamos tu web para que aparezcas primero cuando busquen tus servicios en la IV Región." },
                { icon: <Smartphone />, title: "Diseño Móvil Perfecto", desc: "La mayoría de tus clientes te visitará desde su celular. Les daremos la mejor experiencia." }
              ].map((item, i) => (
                <div key={i} className="group p-8 bg-white rounded-3xl shadow-sm border border-gray-100 transition-all hover:shadow-2xl hover:-translate-y-2">
        ...
        <section id="planes" className="py-24">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold text-gray-900 sm:text-5xl">Planes Transparentes</h2>
              <p className="mt-4 text-green-600 font-bold uppercase tracking-widest">Pago Único • Oferta Lanzamiento</p>
            </div>
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-3 items-center">
              ...
              >
                ...
                <a href="https://wa.me/..." className="mt-10 block w-full py-3 text-center font-bold border-2 border-gray-900 rounded-xl hover:bg-gray-900 hover:text-white transition-all">Elegir Plan</a>
              </motion.div>
              ...
              <motion.div 
                ...
                whileHover="hover"
              >
                <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-full bg-green-600 px-6 py-1 text-sm font-bold text-white uppercase tracking-tighter">Más Recomendado</div>
                ...
                <ul className="mt-8 space-y-4 font-medium">
                  ...
                  <li className="flex items-center text-gray-900"><Award className="h-5 w-5 text-green-500 mr-2"/>Pedidos directos</li>
                </ul>
                <a href="https://wa.me/..." className="mt-10 block w-full py-4 text-center font-bold bg-green-600 text-white rounded-xl shadow-lg shadow-green-600/30 hover:bg-green-700 transition-all">Lo quiero ahora</a>
              </motion.div>
              ...
              >
                ...
                <a href="https://wa.me/..." className="mt-10 block w-full py-3 text-center font-bold border-2 border-gray-900 text-gray-900 rounded-xl hover:bg-gray-900 hover:text-white transition-all">Consultar</a>
              </motion.div>
            </div>
          </div>
        </section>
        ...
        <section id="portafolio" className="py-24 bg-gray-900 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-4xl font-black text-center mb-16 italic">Diseños de Próxima Generación</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                { title: "Estudio Jurídico", category: "Legal", color: "bg-blue-900" },
                { title: "Kitsune Sushi", category: "Gastro", color: "bg-red-900" },
                { title: "Constructora Norte", category: "Business", color: "bg-amber-900" }
              ].map((item, index) => (
                <div key={index} className="group relative rounded-3xl overflow-hidden aspect-[4/5] cursor-pointer">
                  <div className={`absolute inset-0 ${item.color} opacity-40 transition-transform duration-700 group-hover:scale-110`}></div>
                  ...
                  <div className="absolute inset-0 p-8 flex flex-col justify-end transition-all duration-300 group-hover:pb-12">
                    <span className="text-green-500 font-bold text-sm tracking-widest uppercase mb-2 opacity-0 group-hover:opacity-100 transition-opacity translate-y-4 group-hover:translate-y-0">{item.category}</span>
            ...
            <div className="bg-white rounded-[3rem] p-8 md:p-16 flex flex-col md:flex-row items-center gap-12 border border-gray-100 shadow-sm">
              ...
              >
                ...
                <p className="text-gray-600 text-lg leading-relaxed mb-8">
                  Somos <b>Faroweb</b>. Un equipo de desarrolladores apasionados viviendo y trabajando aquí mismo, en La Serena. Entendemos el mercado local porque somos parte de él. Sin intermediarios, sin letra chica.
                </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            ...
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="mt-4 text-sm max-w-xs leading-relaxed text-gray-500">
                Ayudamos a las PYMES de la IV Región y todo Chile a destacar en el mundo digital. Diseño web estratégico y resultados reales.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><a href="#" className="hover:text-green-500 transition-colors">Diseño Web</a></li>
                <li><a href="#" className="hover:text-green-500 transition-colors">E-commerce</a></li>
                <li><a href="#" className="hover:text-green-500 transition-colors">SEO Local</a></li>
              </ul>
            </div>
